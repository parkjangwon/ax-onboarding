...
📜 전체 헌장은 **[PHILOSOPHY.md](PHILOSOPHY.md)** 에 있습니다 — 에이전트의 첫 출근, 일의 소유권 재협상, 내일 아침의 시험. 모든 기능 결정은 이 헌장을 통과해야 합니다.
...
- **자기 확장 안전장치**: 온보딩 이후 에이전트에게 요청하는 추가 세팅도 같은 규약을 따릅니다(설정 편집 전 백업, 매니페스트 기록, 참조 한 줄 편집) — 하니스는 수명 내내 언제든 원상복구 가능한 상태로 유지됩니다.
